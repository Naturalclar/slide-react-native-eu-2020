    ...
    >
      ...
      <ul>
        ...
        <ul>
          ...
          >
            Displays a password input form
          </li>
          <li
            style={{
              color: Colors.baseTextColor,
          ...
          >
            Has disabled button if a form is empty
          </li>
          <li
            style={{
              color: Colors.baseTextColor,
          ...
          >
            Displays loading on network request
          </li>
          <li
            style={{
...
<Page>
  <SubHeading>Supporting Dark Mode</SubHeading>
  <MarginBottom size={60} />
  <Row>
    <Center>
...
<Page>
  <SubHeading>Why is it Important?</SubHeading>
  <Row style={{ flex: 1, justifyContent: "space-evenly" }}>
    <Circle size={360}>
      <Paragraph style={{ color: "white" }}>
        Reduce QA
      </Paragraph>
      <Paragraph style={{ color: "white" }}>Time</Paragraph>
    </Circle>
    <Circle size={360}>
      <Paragraph style={{ color: "white" }}>
        Automate
