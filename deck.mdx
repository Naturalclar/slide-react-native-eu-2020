...
<Page>
  ...
  >
    <Heading>
      ...
      <Text style={{ color: "#d081c4" }}>for</Text> <Text style={{ color: "#030986" }}>React Native</Text>
    </Heading>
    <MarginBottom size={24} />
    <Paragraph>Jesse Katsumata</Paragraph>
...
<Page>
  ...
  <Paragraph>I'm Jesse @natural_clar</Paragraph>
  <Paragraph>Front End Engineer at CureApp, Inc.</Paragraph>
  <Paragraph>Member of React Native Community</Paragraph>
  <Paragraph>❤️ OSS</Paragraph>
  <View
    style={{
      position: "absolute",
      height: 240,
